 ...
 *
 * データソース:
 * - 第2章: エンゲージメント19種類の重み（2023年4月公式リリース）
 * - 第6章: 12種類のフィルター
 * - 第12章: 総まとめと実践ロードマップ
 */
...
export const rankingData: RankingData = {
  ...
  // やってはいけない TOP 10
  // ソース: 2023年4月公式リリースのネガティブ重み + フィルターシステム
  ...
  misconceptions: [
    ...
    // やってはいけないの誤解
    {
      ...
      reality: '公式リリースに外部リンクへの直接ペナルティ重みは存在しない。link_clicked（1.1）はむしろポジティブな重み。SpamFilterの「リンク乱用」は大量の不自然なリンクが対象であり、単一リンクへのペナルティではない。',
      type: 'dont',
      relatedChapters: [2, 6],
    },
    {
