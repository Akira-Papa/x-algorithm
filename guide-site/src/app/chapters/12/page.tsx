        ...
        <section className="mb-16">
          <div className="bg-zinc-900 dark:bg-zinc-800 rounded-lg p-8 text-white">
            <div className="text-center mb-8">
              <BookOpenIcon className="w-12 h-12 mx-auto mb-4 opacity-80" />
              <h2 className="text-2xl font-bold">本書の総括</h2>
              <p className="text-zinc-400 mt-2">12章にわたり学んだことの振り返り</p>
            </div>

            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="bg-zinc-800 dark:bg-zinc-700 rounded-lg p-5">
                <h3 className="font-semibold text-blue-400 mb-3">基礎理解</h3>
              ...
              <div className="bg-zinc-800 dark:bg-zinc-700 rounded-lg p-5">
                <h3 className="font-semibold text-emerald-400 mb-3">技術詳解</h3>
                <ul className="space-y-2 text-zinc-300 text-sm">
                  <li>スコアリングシステム</li>
                  <li>12種類のフィルター</li>
                  <li>IN vs OONの違い</li>
              ...
              <div className="bg-zinc-800 dark:bg-zinc-700 rounded-lg p-5">
                <h3 className="font-semibold text-purple-400 mb-3">実践応用</h3>
                <ul className="space-y-2 text-zinc-300 text-sm">
                  <li>5種類の投稿テンプレート</li>
                  <li>アカウント設計</li>
                  <li>ブランディング</li>
            ...
            <div className="bg-zinc-800/50 rounded-lg p-6 border border-zinc-700">
              <p className="text-zinc-300 text-center">
                ...
                <span className="text-white font-medium">読者に価値を提供し、誠実なコミュニケーションを続けてください。</span>
              </p>
            </div>
          </div>
        </section>
